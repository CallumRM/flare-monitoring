...
#TODO: Add the capacity to take a weighted average, so that observations can be combined into historic averages easier.
    #Will be good for keeping a directory of averaged spectra, which can then be updated regularly.
#TODO: Would be good to have this calculate the RMS of the reuslting averaged spectrum. Might not be practical,
    #in which case an RMS calculating script would be good.
class csv_average:
    def __init__(self):
